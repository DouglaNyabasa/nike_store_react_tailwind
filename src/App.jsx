import {CustomerReviews, Footer,Hero,Service,SpecialOffer,Subscribe,SuperQuality,PopularProducts } from "./sections"
...
export default function App() {
  return (
   <main className="relative">
    ...
    <section className="padding-x sm:py-10 py-16 w-full"> <Subscribe/></section>
